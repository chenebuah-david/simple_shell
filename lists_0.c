...
/**
 * add_node - This adds node to the start of the list
...
/**
 * add_node_end - This adds node to end of list
...
/**
 * print_list_str - This prints only the structure element of
 * a list_t linked list
 * @i: This pointers to first node
 * Return: size of list
 */
...
/**
 * free_list - This frees all nodes of list
